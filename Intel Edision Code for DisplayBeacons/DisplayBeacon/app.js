...
function ActivateBeacons(){
    ...
    hubcontrol.invokeDeviceMethod('Beacon', methodParams, function (err, result) {
    if (err) {
        console.log('The LightBeacon did not respond!');
    } else {
        console.log('Just activated the light beacon:');
...
function DeactivateBeacons(){
    ...
    if (err) {
        ...
        console.log('LightBeacons reset to idle scan:');
        console.log(JSON.stringify(result, null, 2));
    }
});
}
...
//        if (err) {
//          console.error("Error on getting forecast twin message!" + twin);
//          return;
//        }
